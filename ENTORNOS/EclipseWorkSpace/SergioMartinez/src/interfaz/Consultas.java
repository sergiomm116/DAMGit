...
public class Consultas extends JDialog implements ActionListener  {
	...
	Etiquetas data = new Etiquetas(new JButton("Ver departamentos"), new JButton("Ver empleados"), new JButton("Estadisticas departamentos"), new JButton("Estadisticas empleados"));
