...
CORREGIR CORREGIR CORREGIR CORREGIR CORREGIR CORREGIR CORREGIR CORREGIR CORREGIR 
-- EJERCICIO 8--
...
-- EJERCICIO 10 --
ALTER TABLE PROFESORES ADD COSNTRAINT
FK_TASIG FOREIGN KEY (COD_ASIG)
REFERENCES TASIG;

-- EJERCICIO 11 --
SELECT TABLE_NAME, CONTRAINT_NAME, COLUMN_NAME
