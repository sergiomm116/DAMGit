...
CREATE OR REPLACE VIEW EMP2320
AS SELECT EMP_NO, APELLIDO, OFICIO, DEPT_NO FROM EMPLE
WHERE DEPT_NO = 10 AND SALARIO > 1200

INSERT INTO EMP2320 VALUES(5555, 'Ramirez', 'ADMIN', 10);

UPDATE EMP2320 SET APELLIDO = 'Jimenez' WHERE EMP_NO = 5555;

DELETE FROM EMP2320 WHERE EMP_NO = 5555;
