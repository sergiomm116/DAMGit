...
public class MetodosStringsSS {
	...
	public static void main (String[] args) {
		...
		System.out.println(texto1.lastIndexOf("a",7+1));
		...
		System.out.println(texto1.matches(".+[a-x&&[^acd]].+"));
		...
		System.out.println(texto1.valueOf(valor1));
	}
}
